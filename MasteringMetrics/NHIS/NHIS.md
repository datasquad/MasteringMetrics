...
First and foremost we thank Joshua D. Angrist and Jörn-Steffen Pischke for writing Mastering Metrics and indeed for making data and STATA code for some of the analysis that appears in their book available via the [http://masteringmetrics.com/](book's website). 
